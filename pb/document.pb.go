...
type ListDocument struct {
	...
	Data []*DocumentReply `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *ListDocument) GetData() []*DocumentReply {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_document_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x68, 0x65, 0x72, 0x6d, 0x65, 0x73, 0x2e, 0x44, 0x6f, 0x63, 0x75,
	0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22,
...
var file_document_proto_depIdxs = []int32{
	0, // 0: hermes.ListDocument.data:type_name -> hermes.DocumentReply
